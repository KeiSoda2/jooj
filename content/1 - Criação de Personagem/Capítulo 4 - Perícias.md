**Perícias** são as suas habilidades em ações específicas. Elas automaticamente tem um bônus base do valor dos [Atributos](Capítulo%201%20-%20Atributos.md) que as representam. Por exemplo, se seu personagem tiver um valor de 2 em Destreza, você recebe um bônus de +2 em rolagens de Acrobacia (Destreza).
