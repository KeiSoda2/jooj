...
| ------ | --------- | ------------ | ------- | ----- |
| Faixas | 1d6+2d4+4 | Contundente  | -       | +5    |
...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- | ----- |
| Faixas            | Enquanto estiver usando as faixas, seu dano desarmado aumenta para 1d4, causando também 1d4 cada dois pontos de Força. Caso seu dano desarmado já seja superior a 1, você só recebe os dados de dano adicionais.. | 0         | 1     |
